...
namespace FailToBan.Core
{
    public static class RuleTypeExtension
    {
        ...
        private static readonly Dictionary<string, RuleType> mapping = new Dictionary<string, RuleType>()
        {
            ...
            { "nftables_mode", RuleType.NftableMode},
            { "actionstart_on_demand", RuleType.ActionstartOnDemand},
            { "pfctl",  RuleType.Pfctl},
            { "tablename", RuleType.Tablename },
            { "block", RuleType.Block },
            { "actiontype", RuleType.Actiontype },
            { "allports", RuleType.Allports },
            { "multiport", RuleType.Multiport },
            { "_grep_logs", RuleType.GrepLogs },
            { "_grep_logs_args", RuleType.GrepLogsArgs },
            { "_bypass_if_restored", RuleType.BypassIfRestored},
            { "greplimit", RuleType.Greplimit},
            { "grepmax", RuleType.Grepmax },
            { "grepopts", RuleType.Grepopts },
            { "insertpos", RuleType.Insertpos },
            { "destination", RuleType.Destination },
            { "application", RuleType.Application },
            { "srv_cfg_path", RuleType.SrvCfgPath },
            { "srv_cmd", RuleType.SrvCmd },
            { "blck_lst_reload", RuleType.BlckLstReload },
            { "blck_lst_file", RuleType.BlckLstFile },
            { "actionflush", RuleType.Actionflush },
            { "rate", RuleType.Rate },
            { "level", RuleType.Level },
            { "debug", RuleType.Debug },
            { "addr_resolver", RuleType.AddrResolver },
            { "message", RuleType.Message },
            { "family", RuleType.Family },
            { "header", RuleType.Header },
            { "footer", RuleType.Footer },
            { "report", RuleType.Report },
            { "mailcmd", RuleType.Mailcmd },
            { "mailargs", RuleType.Mailargs },
            { "tlp", RuleType.Tlp },
            { "service", RuleType.Service },
            { "loglines", RuleType.Loglines },
            { "zone", RuleType.Zone },
            { "rejecttype", RuleType.Rejecttype },
            { "rich-blocktype", RuleType.RichBlocktype},
            { "dest", RuleType.Dest },
            { "dst", RuleType.Dst},
            { "setnum", RuleType.Setnum },
            { "rulenum", RuleType.Rulenum },
            { "localhost", RuleType.Localhost },
            { "category", RuleType.Category },
            { "userid", RuleType.Userid },
            { "myip", RuleType.Myip},
            { "lines", RuleType.Lines},
            { "minreportinterval", RuleType.Minreportinterval },
            { "maxbufferage", RuleType.Maxbufferedage },
            { "srcport",RuleType.Srcport },
            { "tmpfile", RuleType.tmpfile },
            { "nftable_mode", RuleType.NftableMode },
            { "_nft_list", RuleType.NftList },
            { "_nft_get_handle_id", RuleType.NftGetHandleId },
            { "nftables_type", RuleType.NftablesType },
            { "nftables_family", RuleType.NftablesFamily },
            { "nftables_table", RuleType.NftablesTable },
            { "nftables", RuleType.Nftables},
            { "set_name", RuleType.SetName },
            { "address_family", RuleType.AddressFamily },
            { "lockingopt", RuleType.Lockingopt },
            { "iptables", RuleType.Iptables },
            { "ipmset", RuleType.Ipmset },
            { "_ban_mail_content", RuleType.BanMailContent },
            { "name", RuleType.Name },
            { "ignoreregex", RuleType.Ignoreregex },
            { "maxlines", RuleType.Maxline },
            { "prefregex", RuleType.Prefregex }
    };
